    ...
    <div className='navbar'>
      ...
      <nav className={`navbar__menu ${isMenuOpen ? 'navbar__menu--open' : ''}`}>
        <ul>
          ...
          <li><Link to="/#a_propos" title="À propos !">À propos</Link></li>
          <li><Link to="/#menu" title="Menu">Menu</Link></li>
          <li><Link to="/booking" title="Réservations">Réservations</Link></li>
          <li><Link to="/#commande" title="Commande en ligne">Commande en ligne</Link></li>
